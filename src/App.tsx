				...
				<aside className="w-2/5 h-full p-10 bg-gray-800 divide-y divide-gray-600 rounded-tl-lg">
					...
					<section className="flex flex-col py-6">
						<ul className="flex flex-col">
							...
							<li className="flex flex-row items-center justify-start mb-2">
								<div className="flex items-center justify-center w-8 h-8 mr-4 bg-indigo-900 rounded-full">
									<img src={LinkIcon} alt="Link Icon" className="w-auto h-4" />
								</div>
								<div>
							...
							<li className="flex flex-row items-center justify-start mb-2">
								<div className="flex items-center justify-center w-8 h-8 mr-4 bg-indigo-900 rounded-full">
									<img src={PinIcon} alt="Pin Icon" className="w-auto h-4" />
								</div>
								<div>
				...
				<main className="flex flex-col w-full p-10 bg-gray-700 rounded-tr-lg">
					<section className="mb-4">
						...
						<div className="p-4 pl-16">
							<ul className="flex">
								<li className="flex">
									<span className="mr-8 text-3xl leading-6 text-gray-300">
										•
									</span>
									<div className="flex flex-col w-2/5">
										<h5 className="text-gray-400 text-1x">
											Jan 2021 - Jan 2022 🕑 Contract
										</h5>
									...
									<div className="w-3/5">
										<p className="text-gray-300">
											In this role I worked in a tight-knit multidiciplinary
											team, taking our client’s concept to a fully operational
											and marketable EdTech product.
										</p>
										<ul className="my-2">
											<li className="my-1 text-gray-300">
												• Work directly with the project manager to create a
												plan for design and development sprints.
											</li>
											<li className="my-1 text-gray-300">
